...
TRANSLATIONS = {
    'ko': {
        ...
        'btn_save': '💾 저장',
        'btn_add_to_list': '➕ 목록에 추가',
        'btn_save_all': '💾 일괄 저장',
        'pending_items': '저장 대기 목록',
        'pending_count': '건 대기 중',
        'clear_pending': '대기 목록 비우기',
        'all_saved': '건이 저장되었습니다!',
        'btn_reset': '초기화',
        'btn_analyze': '🚀 분석 시작',
        'btn_clear': '🗑️ 전체 삭제',
        'saved_items': '저장된 항목',
...
API 키가 없어도 기본 분석은 계속 이용 가능합니다!""",
    ...
    'ja': {
        ...
        'btn_save': '💾 保存',
        'btn_add_to_list': '➕ リストに追加',
        'btn_save_all': '💾 一括保存',
        'pending_items': '保存待ちリスト',
        'pending_count': '件待ち',
        'clear_pending': '待ちリストをクリア',
        'all_saved': '件が保存されました！',
        'btn_reset': 'リセット',
        'btn_analyze': '🚀 分析開始',
        'btn_clear': '🗑️ 全削除',
    ...
    - バブルサイズ: 購入金額""",
        ...
        # ログイン
        'login_required': 'サービスを利用するにはログインが必要です。',
        'login': 'ログイン',
        'logout': 'ログアウト',
        'my_account': 'マイアカウント',
        'premium': 'プレミアム会員',
        ...
        'btn_login': 'ログイン',
        'btn_register': '会員登録',
        'register_section': 'アカウントをお持ちでないですか？',
        'register_success': '会員登録が完了しました！ログインしてください。',
        'register_fail': '会員登録中にエラーが発生しました。',
        'login_success': 'ログイン成功！',
        'login_fail': 'ユーザーIDまたはパスワードが正しくありません。',
        'password_mismatch': 'パスワードが一致しません。',
        'username_exists': 'すでに使用されているユーザーIDです。',
        'username_too_short': 'ユーザーIDは4文字以上必要です。',
        'username_too_long': 'ユーザーIDは50文字以下にしてください。',
        'username_invalid': 'ユーザーIDは英数字とアンダースコア(_)のみ使用できます。',
        'password_too_short': 'パスワードは6文字以上必要です。',
        'username_placeholder': '英数字、アンダースコア（4文字以上）',
